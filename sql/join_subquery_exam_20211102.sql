...
from customer c, orders o 
 ...
 -- 조인을 이용한 해결 
 select count(distinct b.publisher) --count(distinct b.publisher) 
...
select b.price, o.saleprice, b.price-o.saleprice 
...
where o.bookid=b.bookid; 
 ...
 select o.orderid, b.price, o.saleprice, b.price-o.saleprice 
 from orders o, book b 
 where o.bookid=b.bookid 
 ...
 -- 자신의 구매액 평균 
 select c.name, avg(saleprice), (select avg(saleprice) from orders) 
 from customer c, orders o 
 where c.custid=o.custid 
 group by c.name 
