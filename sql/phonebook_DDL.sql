...
set fr_name = 'SON',fr_phonenumber='010-8777-5555',fr_email= 'son@naver.com',fr_address = 'ddd'
where idx = 1
;
...
-- 1. 기본 정보 입력
 insert into phoneinfo_basic--()
      values(pib_idx_seq.nextval,'황희찬','010-0123-1111','hh@gmail.com','LONDON',sysdate);
-- 2. 학교 정보 입력
...
select pb.fr_name,pb.fr_phonenumber,pu.fr_u_major,pu.fr_u_year,pu.fr_ref
