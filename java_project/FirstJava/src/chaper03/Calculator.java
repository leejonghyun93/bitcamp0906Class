...
//Calculator 클래스를 정의해봅시다. 
	...
	// 자바에서 상수 : 변수에 최초 초기화된 값을 바꾸지 못한다.!!
	final float PI = 3.145f;
	final String USER_NAME;

	// 생성자 : 초기화 메소드,메소드 구조와 유사 반환가능X
	// 클래스 이름(){}
...
//		에 추가해봅시다.
		...
		System.out.println("===========================");
		System.out.println("원의 둘레의 넓이를 구합니다.\n반지의 이름을 입력해주세요.");
