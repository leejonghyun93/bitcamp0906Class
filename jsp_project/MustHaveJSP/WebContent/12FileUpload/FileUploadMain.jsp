...
<body>
	...
	<form name="fileForm" method="post" enctype="multipart/form-data"
		...
		작성자 : <input type="text" name="name" value="머스트해브" /><br /> 제목 : <input
			...
			type="checkbox" name="cate" value="과제" /> 과제 <input type="checkbox"
			name="cate" value="워드" /> 워드 <input type="checkbox" name="cate"
			value="음원" /> 음원 <br /> 첨부파일 : <input type="file"
			name="attachedFile" /> <br /> <input type="submit" value="전송하기" />
	</form>
</body>
</html>